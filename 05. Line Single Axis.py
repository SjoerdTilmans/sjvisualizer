"""Line Single Axis with generated data.

Run: python "05. Line Single Axis.py" --seconds 12 --fps 30
...
def build_chart(cv, df):
    ...
    return LineChart.line_chart(
        ...
        draw_points=True, time_indicator="year",
    )
...
def main():
    ...
    cv.tk.title("SJVisualizer - Line Single Axis")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Line Single Axis")
        ...
        if args.smoke:
            ...
            print("Line Single Axis: render smoke passed")
        else:
