"""Asia Map with generated data.

Run: python "20. Asia Map.py" --seconds 12 --fps 30
...
def build_chart(cv, df):
    ...
    names = ['China', 'India', 'Japan', 'Russia']
...
def main():
    ...
    cv.tk.title("SJVisualizer - Asia Map")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Asia Map")
        ...
        if args.smoke:
            ...
            print("Asia Map: render smoke passed")
        else:
