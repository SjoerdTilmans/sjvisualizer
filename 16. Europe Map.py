"""Europe Map with generated data.

Run: python "16. Europe Map.py" --seconds 12 --fps 30
...
def main():
    ...
    cv.tk.title("SJVisualizer - Europe Map")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Europe Map")
        ...
        if args.smoke:
            ...
            print("Europe Map: render smoke passed")
        else:
