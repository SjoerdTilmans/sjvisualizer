"""North America Map with generated data.

Run: python "19. North America Map.py" --seconds 12 --fps 30
...
def main():
    ...
    cv.tk.title("SJVisualizer - North America Map")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("North America Map")
        ...
        if args.smoke:
            ...
            print("North America Map: render smoke passed")
        else:
