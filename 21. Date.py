"""Date with generated data.

Run: python "21. Date.py" --seconds 12 --fps 30
...
from sjvisualizer import Canvas, Date
...
def build_chart(cv, df):
    ...
    return Date.date(
        ...
        prefix="Date: ", time_indicator="day",
    )
...
def main():
    ...
    try:
        ...
        if args.smoke:
            ...
            print("Date: render smoke passed")
        else:
