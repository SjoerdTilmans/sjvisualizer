"""Total with generated data.

Run: python "22. Total.py" --seconds 12 --fps 30
...
from sjvisualizer import Canvas, Total
...
def main():
    ...
    cv.tk.title("SJVisualizer - Total")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Total")
        ...
        if args.smoke:
            ...
            print("Total: render smoke passed")
        else:
