"""Legend with generated data.

Run: python "23. Legend.py" --seconds 12 --fps 30
...
from sjvisualizer import Canvas, Legend
...
def main():
    ...
    cv.tk.title("SJVisualizer - Legend")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Legend")
        ...
        if args.smoke:
            ...
            print("Legend: render smoke passed")
        else:
