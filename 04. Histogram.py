"""Histogram with generated data.

Run: python "04. Histogram.py" --seconds 12 --fps 30
...
from sjvisualizer import Canvas, Histogram
...
def main():
    ...
    cv.tk.title("SJVisualizer - Histogram")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Histogram")
        ...
        if args.smoke:
            ...
            print("Histogram: render smoke passed")
        else:
