"""Africa Map with generated data.

Run: python "18. Africa Map.py" --seconds 12 --fps 30
...
def build_chart(cv, df):
    ...
    names = ['Nigeria', 'Egypt', 'South Africa']
...
def main():
    ...
    cv.tk.title("SJVisualizer - Africa Map")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Africa Map")
        ...
        if args.smoke:
            ...
            print("Africa Map: render smoke passed")
        else:
