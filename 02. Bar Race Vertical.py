"""Bar Race Vertical with generated data.

Run: python "02. Bar Race Vertical.py" --seconds 12 --fps 30
...
def build_chart(cv, df):
    ...
    return BarRace.bar_race(
        ...
        orientation="vertical", number_of_bars=3, allow_decrease=True,
        unit=" GWh",
    )
...
def main():
    ...
    cv.tk.title("SJVisualizer - Bar Race Vertical")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("Bar Race Vertical")
        ...
        if args.smoke:
            ...
            print("Bar Race Vertical: render smoke passed")
        else:
