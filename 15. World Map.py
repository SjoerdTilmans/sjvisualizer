"""World Map with generated data.

Run: python "15. World Map.py" --seconds 12 --fps 30
...
def build_chart(cv, df):
    ...
    names = ['United States', 'China', 'Brazil']
...
def main():
    ...
    cv.tk.title("SJVisualizer - World Map")
    if args.smoke:
        cv.tk.withdraw()
    try:
        cv.add_title("World Map")
        ...
        if args.smoke:
            ...
            print("World Map: render smoke passed")
        else:
